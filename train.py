...
# some paths
parser.add_argument("--train_file", type=str, default="./data/my_data/train_%s_tf.txt"%data_name,
                    help="The path of the training txt file.")

parser.add_argument("--val_file", type=str, default="./data/my_data/val_%s_tf.txt"%data_name,
...
parser.add_argument("--anchor_path", type=str, default="./data/%s_%s_anchors.txt"%(anchors_name,data_name),
